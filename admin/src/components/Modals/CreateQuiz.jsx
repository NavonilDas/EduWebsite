...
class CreateQuiz extends React.Component {
  ...
  submit() {
    ...
    if (this.props.selected) {
      request = axios.put(
        `${HOST}test/${this.props.testID}/${this.props.selected._id}`,
        body,
        config
      );
    } else {
      request = axios.post(
        `${HOST}test/add/${this.props.testID}`,
        body,
        config
      );
    }
    ...
    return (
      <div className="create-quiz modal">
        ...
        >
          ...
          {this.state.opt1 !== "" ? (
            <FormControlLabel
              control={<Checkbox name="ans1" color="primary" />}
          ...
          {this.state.opt2 !== "" ? (
            <FormControlLabel
              control={<Checkbox name="ans2" color="primary" />}
          ...
          {this.state.opt3 !== "" ? (
            <FormControlLabel
              control={<Checkbox name="ans3" color="primary" />}
          ...
          {this.state.opt4 !== "" ? (
            <FormControlLabel
              control={<Checkbox name="ans4" color="primary" />}
